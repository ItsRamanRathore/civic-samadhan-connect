...
// 1. Configure the Nodemailer transporter with Brevo's SMTP details
const transporter = createTransport({
  host: "smtp-relay.brevo.com",
  port: 587,
  secure: false, // Use 'true' for 465, 'false' for other ports
  auth: {
    user: Deno.env.get("96dd52001@smtp-brevo.com"), // Your Brevo SMTP login (e.g., your email)
    pass: Deno.env.get("xsmtpsib-b6a54677add71e503e33e8b95c19b52cc4728494d737d28153f43bf5066ffbfe-RZLzOT9Y5pdSjXEM"), // Your Brevo SMTP key
  },
});
...
    // 2. Create the email content object for Nodemailer
    const mailOptions = {
      from: "Civic Care <notifications@resend.dev>", // This needs to be a verified sender in Brevo
      to: userEmail,
...
    return new Response(JSON.stringify({ messageId: emailResponse.messageId }), {
      status: 200,
      headers: {
